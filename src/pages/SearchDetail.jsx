...
const SearchDetail = () => {
  ...
  const sunlight = Array.isArray(plantData.sunlight) ? plantData.sunlight.join(', ') : plantData.sunlight || 'Unknown';
  ...
  return (
    <div className="search-detail-page">
      <div className="plant-main">
        <img src={plantData.default_image?.regular_url} alt={plantData.common_name} className="plant-image" />
